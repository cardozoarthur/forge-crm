const moduleTasks = [
  {
    ...
    expected_output: { expected_output: "Authorized CRM tenant bootstrap plan" },
    validation_rules: [
  ...
  },
  {
    ...
    expected_output: { expected_output: "Workflow-backed CRM entity graph" },
    validation_rules: [
  ...
  },
  {
    ...
    expected_output: { expected_output: "Relationship workflows and Kanban pipeline views" },
    validation_rules: [
  ...
  },
  {
    ...
    expected_output: { expected_output: "Proposal, contract, signature and follow-up workflow chain" },
    validation_rules: [
  ...
  },
  {
    ...
    expected_output: { expected_output: "Ticket, SLA and omnichannel queue workflows" },
    validation_rules: [
  ...
  },
  {
    ...
    expected_output: { expected_output: "Campaign, segmentation, landing page, form and nurture workflows" },
    validation_rules: [
  ...
  },
  {
    ...
    expected_output: { expected_output: "Internal operations workflow pack" },
    validation_rules: [
  ...
  },
  {
    ...
    expected_output: { expected_output: "Lead classifier, opportunity prioritizer and next-step recommender contracts" },
    validation_rules: [
  ...
  },
  {
    ...
    expected_output: { expected_output: "TUI panels and web views for CRM workflows" },
    validation_rules: [
  ...
  },
  {
    ...
    expected_output: { expected_output: "CRM validation package and forge-core backlog artifact" },
    validation_rules: [
