...
- Node tests passed: 67 tests, 0 failures.
...
- CRM web snapshot generation produced `schema_version=forge.crm_web_app_snapshot.v1`, 8 business surfaces, 12 workflow graph nodes, document queue lanes and 19 Forge command actions without browser persistence.
