...
- Node tests passed: 122 tests, 0 failures.
- CRM workflow pack generation produced `schema_version=forge.crm_workflow_pack.v1`, 24 workflows, 87 object types and complete scope coverage.
...
- Forge Addon package generation passed with 34 runtime contracts, 75 artifact types and 34 event types.
...
- Tenant bootstrap returned `addon_executor_completed`, `bootstrap_workflow_count=24` and `bootstrap_complete_scope=true`.
