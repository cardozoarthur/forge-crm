...
- Node tests passed: 70 tests, 0 failures.
- CRM workflow pack generation produced `schema_version=forge.crm_workflow_pack.v1`, 13 workflows, 54 object types and complete scope coverage.
...
- CRM web snapshot generation produced `schema_version=forge.crm_web_app_snapshot.v1`, 8 business surfaces, 13 workflow graph nodes, document queue lanes and 20 Forge command actions without browser persistence.
