...
- `scripts/smoke-forge-runtime.mjs` registers the worker in Forge and executes planner, tenant bootstrap, operating snapshot, relationship timeline, operating copilot, lead classification, proposal generation, commercial follow-up forecast, account management, contract signature, document generation, document validation, marketing campaign automation, marketing form capture, ticket SLA triage, project handoff planning and omnichannel handoff contracts.
...
- Forge action list for runtime contracts such as operating snapshot refresh, tenant bootstrap, relationship timeline recording, operating copilot, proposal generation, commercial follow-up forecast, account management, contract signature management, document generation, document validation, marketing campaign automation, form submission capture, ticket SLA triage, project handoff planning and omnichannel handoff.
