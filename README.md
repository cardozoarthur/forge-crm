...
- `scripts/smoke-forge-runtime.mjs` registers the worker in Forge and executes planner, tenant bootstrap, operating snapshot, operating copilot, lead classification, proposal generation, document validation and omnichannel handoff contracts.
...
- Forge action list for runtime contracts such as operating snapshot refresh, tenant bootstrap, operating copilot, proposal generation, document validation and omnichannel handoff.
