...
- `scripts/generate-crm-web-snapshot.mjs` emits the static web app snapshot derived from the operating model, including Forge-owned action invocation plans, design-system artifacts, subworkflow orchestration, workflow automation design and operational workflow cadences for schedules, waits and triggers.
